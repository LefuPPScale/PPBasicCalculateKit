 ...
 *
 */
@property(nonatomic, copy) NSString *secret;                     //!< 授权密钥
...
@property (nonatomic,assign) unsigned int         bhZTwoLegsEnCode50Khz;    //!< 双脚阻抗加密值(下位机上传值) 范围0 ~ 0xFFFFFF
@property (nonatomic,assign) unsigned int         bhZTwoLegsEnCode100Khz;   //!< 双脚阻抗加密值(下位机上传值) 范围0 ~ 0xFFFFFF
...
@property (nonatomic,readonly,assign) float         bhZTwoLegsDeCode50Khz;  //!< 双脚阻抗值(Ω)  200 ~ 1200 for debug 通常不显示
@property (nonatomic,readonly,assign) float         bhZTwoLegsDeCode100Khz; //!< 双脚阻抗值(Ω)  200 ~ 1200 for debug 通常不显示
